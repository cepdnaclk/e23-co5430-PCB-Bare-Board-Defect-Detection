...
This project tackles the challenge using a dual-pronged approach, allowing users to choose between a state-of-the-art **Deep Learning (YOLO)** object detection model, and a blazing-fast **Classical Topological Computer Vision** pipeline that operates without needing a GPU.
...
4. **Short Circuit**: Excess copper that incorrectly bridges two distinct traces.
5. **Spur**: A protrusion of excess copper attached to a single trace.
6. **Spurious Copper**: An isolated island of excess copper not touching any traces.
...
### 3. Advanced Classical Topological Classification
...
---
*Created for CO5430 Computer Vision Project.*
